...
class ComputerIntro(Scene):
    def construct(self):
        ...
        idea1 = Text("Input", font_size=48).next_to(title, DOWN, buff=1)
        idea2 = Text("• Processing", font_size=48).next_to(idea1, DOWN)
        idea3 = Text("• Output", font_size=48).next_to(idea2, DOWN)
